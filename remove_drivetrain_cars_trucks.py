...
print("=" * 70)
print("  REMOVE DRIVETRAIN SECTION (CARS & TRUCKS ONLY)")
print("=" * 70)
...
# Pattern to match DRIVETRAIN section
# Matches from "DRIVETRAIN" (or "DRIVETRAIN:") until the end OR until next major section
pattern = r'DRIVETRAIN:?\s*\n\s*Engine.*?(?=\n\n[A-Z]{3,}|$)'
